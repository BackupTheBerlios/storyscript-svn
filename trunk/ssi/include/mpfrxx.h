...
public:
  ...
  //DCJ:
  void set_prec(mp_prec_t P) { return mpfr_set_prec(mp, P); }
  ...
  */
  ...
  //DCJ: Uncommented this stuff and added GMP_RNDN argument to mpfr_init_set_str calls
  ///*
  explicit __gmp_expr(const char *s)
  {
	  mpfr_init_set_str(mp, s, mpfr_default_base, GMP_RNDN);
  }

  __gmp_expr(const char *s, int base)
  {
	  mpfr_init_set_str(mp, s, base, GMP_RNDN);
  }
  
  explicit __gmp_expr(const std::string &s)
  {
	  mpfr_init_set_str(mp, s.c_str(), mpfr_default_base, GMP_RNDN);
  }

  __gmp_expr(const std::string &s, int base)
  {
	  mpfr_init_set_str(mp, s.c_str(), base, GMP_RNDN);
  }
  //*/
  ...
  */
  ...
  //DCJ: Uncommented and "fixed" this stuff
  ///*
  __gmp_expr & operator=(const char *s)
  { 
	  mpfr_set_str(mp, s, mpfr_default_base, GMP_RNDN); return *this;
  }

  __gmp_expr & operator=(const std::string &s)
  { 
	  mpfr_set_str(mp, s.c_str(), mpfr_default_base, GMP_RNDN); return *this;
  }

  // string input/output functions
  int set_str(const std::string &s, int base)
  { 
	  return mpfr_set_str(mp, s.c_str(), base, GMP_RNDN); 
  }
  //*/
  ...
  //DCJ: Uncommented
  signed long get_si() const { return mpfr_get_si(mp, GMP_RNDN); }
  unsigned long get_ui() const { return mpfr_get_ui(mp, GMP_RNDN); }
...
//DCJ: Changed following line from template <> so it will compile on MSVC++
template <class T>
